...
function Formulario() {
  ...
  const onSubmit = handleSubmit((data) => {
    ...
    let userArr = JSON.parse(userArrString);
    ...
    sessionStorage.setItem('usuario', JSON.stringify(userArr));
  ...
  return (
    <>
      <form className="form-user" onSubmit={onSubmit}>
        <h2 className="title_form-user">Registrarse</h2>
        <div>
          <label>Nombre:</label>
          <input
            type="text"
        ...
        <div className="button-check-container_form-user">
          <div className="checkbox_form-user">
            <input
              type="checkbox"
              name="aceptaTerminos"
